...
def feature_extract(url,malicious):
	...
	Feature['DomainInSubdomains'].append(DomainInSubdomains(subdomain))
	Feature['DomainInPaths'].append(DomainInPaths(path))
...
#print feature_extract("http://facebook.com",1)
